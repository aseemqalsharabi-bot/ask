...
const POST_CONTENT: Record<string, { title: string, content: React.ReactNode, image: string, keywords: string, description: string }> = {
  'antena-mimo-5g': {
    ...
    keywords: 'انتينا ميمو, انتينا ميمو 5G, الانتنتينا الذهبي 30 ديبي, حل ضعف النت, مقوي شبكة الجوال',
  ...
  'best-modified-routers': {
    ...
    keywords: 'تعديل راوتر 5G, راوتر معدل يشغل جميع الشرائح, هواوي CPE 5 معدل, راوتر Zyxel 5G, حل ضعف النت',
  ...
  'solve-ping-gaming': {
    ...
    keywords: 'حل مشكلة البنق, تقطيع الالعاب, تثبيت الترددات 5G, انتينا ميمو, مقوي العاب',
